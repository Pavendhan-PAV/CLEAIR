...
<html>
<head>
<title>Dashboard | Industrialist</title>
...
<div class="header" >
			...
			<div class="navbar-top" >
					...
					<li ><a href="index.php" data-hover="Home">Home</a> </li>
						...
						<?php
							...
							{
						?>
						<a class="naming" id="active2" href="i_dashboard.php"  ><?php echo($_SESSION['iusername']);  ?><b ></b></a>
						<a href="logout.php" class="naming" >Logout<b ></b></a>
						<?php }
						else if(isset($_SESSION['fID2']))
						{?>
							<a href="i_dashboard.php" class="naming" ><?php echo($_SESSION['fID2'])  ?><b ></b></a>
						<?php
					}
						else if(isset($_SESSION['iID']))
							{
						?>
						<a href="i_dashboard.php" class="naming" ><?php echo($_SESSION['iusername'])  ?><b ></b></a>
						<a href="logout.php" class="naming" >Logout<b ></b></a>
						<?php }
						else if(isset($_SESSION['iID2']))
						{?>
							<a href="i_dashboard.php" class="naming" ><?php echo($_SESSION['iusername2'])  ?><b ></b></a>
						<?php 
					} else{ ?>
	...
	<div class="ser-top ser-top-c" style="margin-bottom: 40px; background: transparent;">
					...
					<h2 style="font-weight: normal;color: white; padding-top: 2.7em;">Industrialist Dashboard</h2>
					<div class="ser-t" style="width: 80%;">
						<b></b>
						<span style="background-color: transparent;"><i></i></span>
						<b class="line"></b><br><br>
						<a class="naming2" href="i_newreq.php">New  Pickup requests</a><br>
