<?php
	...
	if(isset($_SESSION["fusername2"]))
		unset($_SESSION["fusername2"]);

	if(isset($_SESSION["iusername"]))
		unset($_SESSION["iusername"]);

	if(isset($_SESSION["iusername2"]))
		unset($_SESSION["iusername2"]);
...
<div class="header" >
	...
	<!---->
	<div class="log" style="margin-bottom: 250px;">
		<div class="container">
	...
	<div class="reg2">
		...
		<form action="f_redirect.php" method="POST">
			<?php
			echo"<tr>";
		echo"<td>"; ?>
		<h2 style="font-weight: normal;color: white; font-size: 1.75em;"> Please Enter your Pincode to check whether your area is serviceable</h2> 
		<?php echo"</td>";
